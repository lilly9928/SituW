...
class GLMClient():
    ...
    def load_base_model(self, base_model):
        ...
        tokenizer = AutoTokenizer.from_pretrained(base_model, trust_remote_code=True,cache_dir='/data3/hg_weight/hg_weight')
    ...
    def load_lora_params(self, lora_paths):
        ...
        for lora_path in lora_paths:
            config = PeftConfig.from_pretrained(lora_path,cache_dir='/data3/hg_weight/hg_weight')
